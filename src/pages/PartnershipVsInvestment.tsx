...
import RichtextContent from "@/components/debt-restructuring/RichtextContent";
import { useCommonPattern } from "@/hooks/useCommonPattern";
import React from "react";

export default function PartnershipVsInvestment() {
  const { data, loading, error } = useCommonPattern("partnershipVsInvestment");
  return (
    <div>
