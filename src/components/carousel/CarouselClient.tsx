...
export default function CarouselClient({
  ...
  return (
    <div ref={rootRef} className="absolute inset-0">
      {/* Only mount extra images after leaving slide 0 — avoids fighting the SSR LCP img */}
      {!isFirstSlide && (
      ...
      {/* TEXT OVERLAY */}
      <div className="absolute inset-0 flex items-center justify-center px-6 md:px-[120px] text-white z-10">
        <div className="w-full max-w-[1140px] mx-auto flex flex-col md:flex-row items-start md:items-center gap-6 md:gap-10 mt-24">
          ...
          >
            <h2
              className={`text-4xl md:text-[62px] prata font-light leading-[39px] md:leading-[82px] max-w-[690px] mx-2 md:mx-0 ${
                isFirstSlide ? "" : animTitle
              }`}
            >
              {slide.title}
            </h2>
